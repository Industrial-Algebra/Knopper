...
- [The Machine Model](./concepts/machine-model.md)
...
- [Writing a Machine](./guide/writing-a-machine.md)
- [Composing Machines](./guide/composing-machines.md)
- [Layout and Rendering](./guide/layout-and-rendering.md)
...
- [Machine & PureMachine](./api/machine.md)
- [Scene Builders](./api/scene.md)
- [Standard Machines](./api/standard-machines.md)
- [Collaboration Types](./api/collaboration.md)
- [Backends](./api/backends.md)

# Design

- [Embedding Contract (Wallace)](./design/embedding-contract.md)
